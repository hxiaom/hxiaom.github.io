...
最近在思考如何经营一个公司的框架，运营是不可缺少的一环，因此在别人的推荐列表中看到了张亮的这本书。《从零开心做运营》框架清晰，内容详细，是了解的运营的工作的一本好书。

运营是非常复杂的一套，要想练好基本功入门，我想得两年时间。但我想也不必被张亮这详尽的阐述吓到，运营也可以很简单，说白了就是从流量建设和用户维系两个方面想办法，不管办法是简单还是复杂，都是运营。而运营的对象在大的方面又分为内容运营，用户运营，活动运营。不用害怕的是，最开始的框架都是简单的，方法库里也只有一两件武器，但也是有效的。
